...
BOT_TOKEN = environ.get('BOT_TOKEN', "6691829320:AAGuvZED2eg7bCR8oZrSwzumORHvmrogd3g")

# Bot settings
CACHE_TIME = int(environ.get('CACHE_TIME', 300))
USE_CAPTION_FILTER = bool(environ.get('USE_CAPTION_FILTER', True))

PICS = (environ.get('PICS', 'https://graph.org/file/6153606dfda8e0dc1c1bd.jpg')).split() #SAMPLE PIC
...
CODE = (environ.get('CODE', 'https://telegra.ph/file/1ef8871644b6c24e3d219.jpg'))
...
AUTH_CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('AUTH_CHANNELS', '-1002274354771').split()]  # Replace with your channel IDs or usernames
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002409948597') # support group id ( make sure bot is admin )
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002409948597') # request channel id ( make sure bot is admin )
...
SHORTLINK_API = environ.get('SHORTLINK_API', '4ace664b1ece84ee5ef01e4f55a6dcce9f007eb5')
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/tgcwsupport') #Support group link ( make sure bot is admin )
...
if HAS_SSL:
    URL = "https://web-c4fed7pnjnm8.up-de-fra1-k8s-1.apps.run-on-seenode.com/".format(FQDN)
else:
    URL = "https://web-c4fed7pnjnm8.up-de-fra1-k8s-1.apps.run-on-seenode.com/".format(FQDN)

# add premium logs channel id
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002052274277'))
